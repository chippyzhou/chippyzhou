...
我是 **周薯**，一名 **华南理工大学（SCUT）软件工程 (SE)** 专业的本科生。
目前是 **NLP (自然语言处理)** 领域的初学者 🌱，正在补习 **Python** 基础和深度学习相关知识。

这里主要用来存放我的学习笔记、练习代码以及一些还在摸索中的小 Demo。
路虽远，行则将至。
...
| :--- | :--- | :--- | :--- |
| 🔴 **High** | **Pytorch学习** | `Fighting` | 寒假开始系统学习 Deep Learning |
| 🟡 **Med** | **学习资料上传** | `Planned` | 计算方法算法实现/计算机系统实验代码 |
| 🟢 **Low** | |  |  |
